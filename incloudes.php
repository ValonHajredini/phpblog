...
htmlForms::Form(['method'=>'get','action'=>'form.php','class' => 'iliri','mbiemri'=>'gojani']);
htmlForms::textField('firstname','cls_form','first name');
echo '<br>';
htmlForms::passwordField('password','cls_password','password123',['palaceholder'=>'new password']);
htmlForms::endForm();